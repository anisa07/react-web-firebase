...
export default class Chat extends Component {
	constructor(props){
		super(props);
		this.state = {
			chats: [], content: '', readError: null, writeError: null, loadingChats: false
		};
	...
	async componentDidMount(){
		...
		analytics.visitPage(this.props.location.pathname);
				...
				<div className="chat-area" ref={this.myRef}>
					...
					{chats.map(chat => {
						return <p key={chat.timestamp}
											className={"chat-bubble " + (this.user.uid === chat.uid ? "current-user" : "")}>
							{chat.content}
							<br/>
